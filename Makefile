...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		    DATA/chatty.conf1 DATA/chatty.conf2 connections.h client.c \
            configuration.c configuration.h connections.c hashtable.c \
            hashtable.h listener.h listener.c queue.h queue.c \
            Relazione_Lavorati.pdf \
            request_handler.h request_handler.c script_chatterbox.sh \
            testconf.sh testfile.sh testleaks.sh teststress.sh \
            threadpool.h threadpool.c user.h user_manager.h user_manager.c \
            worker.h worker.c 
# inserire il nome del tarball: es. NinoBixio
TARNAME=LisaLavorati
...
#
###################################################################
UNIX_PATH       = /tmp/chatty_socket_535658
STAT_PATH       = /tmp/chatty_stats_535658.txt
DIR_PATH        = /tmp/chatty_535658
