...
./client -l $1 -k paperino -p -S "aaaaaaaaaaaaaaaaaaaaaaaaaaa1":minni -S "bbbbbbbbbbbbbbbbb1":pluto -S "ccccccccccccccccc1": -S "ddddddddddddddddddddd1":topolino -s ./libchatty.a:minni
